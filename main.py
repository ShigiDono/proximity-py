...
curve11 = p11.plot(data11, pen = pg.mkPen(color=(255, 0, 0)))
curve12 = p12.plot(data12, pen = pg.mkPen(color=(0, 255, 0)))
curve13 = p13.plot(data13, pen = pg.mkPen(color=(0, 0, 255)))
...
def update_data():
	...
	while ser.isOpen():
		...
		if len(numbers) != 7:
			continue
		data11.append(1.0/numbers[4])
		del data11[0]
		data12.append(numbers[5])
		del data12[0]
		data13.append(1.0/numbers[6])
		del data13[0]
